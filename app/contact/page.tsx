        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-bold text-lg text-gray-800 mb-3">📧 General Inquiries</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-bold text-lg text-gray-800 mb-3">💡 Feature Requests</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-bold text-lg text-gray-800 mb-3">🐛 Bug Reports</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-bold text-lg text-gray-800 mb-3">🎓 Educational Partnerships</h3>
              <p className="text-gray-700">
          ...
          <div className="p-6 rounded-xl border-2 border-gray-200">
            <h3 className="font-bold text-lg text-gray-800 mb-2">Have a quick question?</h3>
