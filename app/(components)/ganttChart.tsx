    ...
    <div className="p-5 gantt-chart-container">
      ...
      {ganntChartProcesses.length === 0 ? (
        <div className="border border-border rounded-lg p-6 text-center">
          ...
          <h3 className="font-semibold text-foreground mb-2">Gantt Chart Visualization</h3>
      ...
      <div className="ganntChart">
        <div className="flex">
          <div className="w-16">
            <div className="bg-muted py-3 text-center text-lg font-bold border-2 border-black rounded-md">
              <p>start</p>
            </div>
