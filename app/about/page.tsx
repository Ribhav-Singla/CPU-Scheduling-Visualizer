...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about CPU Scheduling Visualizer - our mission to make OS concepts accessible through free interactive visualization tools.",
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-8 rounded-2xl p-8" style={{ background: 'linear-gradient(to right, rgba(18, 172, 238, 0.1), rgba(93, 244, 136, 0.1))' }}>
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Who We Help</h2>
